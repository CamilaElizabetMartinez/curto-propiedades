		...
		<div class="row">
			...
			<div class="col-sm-6 col-md-3">
				<ul class="social text-center mg-b-xs">
					...
					<li><a href="https://www.facebook.com/curtopropiedades/" target="_blank"><i class="fa fa-facebook fa-fw"></i></a></li>
			...
			<div class="col-sm-6 col-md-4">
				...
				<div id="mc_embed_signup">
					<form action="https://curtopropiedades.us10.list-manage.com/subscribe/post?u=e94bf2ab6734bad7f992a66a7&amp;id=96a070572f" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
					    <div id="mc_embed_signup_scroll">
							<div class="form-group">
								<input class="form-control required email" type="email" value="" name="EMAIL" id="mce-EMAIL" placeholder="<?php echo $t['cnt']['3']; ?>" >
							</div>
							<div class="form-group">
								<input class="form-control" type="text" value="" name="FNAME" id="mce-FNAME" placeholder="<?php echo $t['cnt']['2']; ?>">
							</div>
					    
					    	<input type="submit" class="btn btn-color2 full" value="<?php echo $t['gui']['4']; ?>" name="subscribe" id="mc-embedded-subscribe">
					    </div>
					</form>
				</div>
				<!--End mc_embed_signup-->
