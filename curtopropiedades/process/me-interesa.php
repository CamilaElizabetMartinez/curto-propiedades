...
$subject = 'Curto Propiedades: Recibiste un pedido de informacion desde la web';

$contenido = file_get_contents($pathRoot . 'resp/me-interesa.html');

if ($_POST['nombre_completo']=='' &&  $_POST['email']=='' && $_POST['telefono']=='') {
