              ...
              <div class="row">
                <div class="col-xs-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="valor_mensual_fulltime" class="form-control" placeholder="Mensual" value="<?php echo $obj->valor_mensual_fulltime; ?>" required>
                  </div>
                </div>
                <div class="col-xs-6">
                  <div class="form-group">
                    <label class="label-control">Quincenal</label>
                    <input type="text" name="valor_quincenal_fulltime" class="form-control" placeholder="Quincenal" value="<?php echo $obj->valor_quincenal_fulltime; ?>" required>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="bg bg-gl pd-full-lg mg-lg-b">
              ...
              <div class="row">
                <div class="col-xs-6">
                  <div class="form-group">
                    <label class="label-control">Mensual</label>
                    <input type="text" name="valor_mensual_partime" class="form-control" placeholder="Mensual" value="<?php echo $obj->valor_mensual_partime; ?>" required>
                  </div>
                </div>
                <div class="col-xs-6">
                  <div class="form-group">
                    <label class="label-control">Quincenal</label>
                    <input type="text" name="valor_quincenal_partime" class="form-control" placeholder="Quincenal" value="<?php echo $obj->valor_quincenal_partime; ?>" required>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-xs-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="valor_hora_sala" class="form-control" placeholder="Hora" value="<?php echo $obj->valor_hora_sala; ?>" required>
                  </div>
                </div>
              </div>
            </div>
