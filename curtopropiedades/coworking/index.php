				...
				<div id="hero-carousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="assets/images/hero_slides/home1.jpg" class="image-fixed-height -md d-block w-100">
							<div class="carousel-caption">
								<div class="container">
									<h5 class="txt-8 font-1 mb-lg-5">La calidez del barrio con los servicios <br>profesionales que necesitás para desarrollarte.</h5>
								</div>
							</div>
						</div>
						<div class="carousel-item">
							<img src="assets/images/hero_slides/home2.jpg" class="image-fixed-height -md d-block w-100">
							<div class="carousel-caption">
								<div class="container">
									<h5 class="txt-8 font-1 mb-lg-5">Planes flexibles y con precios amigables <br>para ayudarte a crecer.</h5>
								</div>
							</div>
						</div>
						<div class="carousel-item">
							<img src="assets/images/hero_slides/home3.jpg" class="image-fixed-height -md d-block w-100">
							<div class="carousel-caption">
								<div class="container">
									<h5 class="txt-8 font-1 mb-lg-5">Vos impulsá tu negocio, <br>¡del resto nos ocupamos nosotros!</h5>
								</div>
							</div>
						</div>
					</div>
			...
			<section id="salas" class="block-home-salas my-3">
				<div id="salas-carousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						<div class="carousel-item">
							<img src="assets/images/salas_slides/slide2.jpg" class="image-fixed-height -sm d-block w-100">
						</div>
						<div class="carousel-item">
							<img src="assets/images/salas_slides/slide3.jpg" class="image-fixed-height -sm d-block w-100">
						</div>
					</div>
			...
			<section id="lugar" class="block-home-lugar my-3">
				<div id="lugar-carousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						<div class="carousel-item">
							<img src="assets/images/lugar_slides/slide2.jpg" class="image-fixed-height -md d-block w-100">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="color-w mr-5 mb-5">
								...
								<p class="txt-3 mb-3">
									// Dirección: <a href="https://www.google.com/maps/place/Vicente+L%C3%B3pez+515,+B1842AUL+Monte+Grande,+Buenos+Aires/data=!4m2!3m1!1s0x95bcd160967f8ec7:0x647ca90f3d6625f?sa=X&ved=2ahUKEwjauobBm9fpAhVRA9QKHZ8wAG8Q8gEwAHoECAsQAQ" class="link-underlined color-w -hover-c4" target="_blank">Vicente López 515, B1842<br class="d-none d-md-block">
										Monte Grande, Buenos Aires</a>
									<br><br>
									// Teléfono: <a href="tel:+5401152639039" class="link-underlined color-w -hover-c4">011 5263-9039</a>
									<br><br>
									// e-mail: <a href="mailto:coworking@curtopropiedades.com" class="link-underlined color-w -hover-c4">coworking@curtopropiedades.com</a>
								</p>
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="row align-items-center">
						...
						<div class="col-md-6">
							<ul class="nav-social list-unstyled d-flex">
								<li><a href="https://www.facebook.com/curtocoworking" target="_blank" class="mr-3"><i class="fab fa-facebook-f fa-2x fa-fw"></i></a></li>
								<li><a href="https://www.instagram.com/curtocoworking/" target="_blank"><i class="fab fa-instagram fa-2x fa-fw"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
