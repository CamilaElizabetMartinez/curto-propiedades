					...
					<div class="row justify-content-center">
						<div class="col-lg-9">
							<div class="text-center">
								...
								<a href="#" class="btn btn-outline-primary btn-lg px-5 mb-5">¡Quiero más info!</a>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="bg-alpha border-radius p-2 p-md-4">
								<form action="#">
									<div class="form-group">
										<input type="email" class="form-control form-control-lg" placeholder="Nombre">
									</div>
									<div class="form-group">
										<input type="email" class="form-control form-control-lg" placeholder="E-mail">
									</div>
									<div class="form-group">
										<textarea class="form-control form-control-lg" rows="4" placeholder="Contanos tu necesidad"></textarea>
									</div>
						...
						<div class="col-md-6">
							<div class="bg-alpha border-radius p-2 p-md-4 mb-5">
								<form id="formContact" action="#" method="POST" data-toggle="validator">
									...
									<p id="formContactResponse" class="color-w mt-4 position-absolute"></p>
								</form>
							</div>
						</div>
					</div>
