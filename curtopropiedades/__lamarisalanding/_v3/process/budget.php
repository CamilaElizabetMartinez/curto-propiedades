...
$subject = 'La Marisa: Recibiste una solicitud de presupuesto desde la landing';

$contenido = file_get_contents($pathRoot . 'resp/budget.html');

if ($_POST['nombre_completo']=='' &&  $_POST['email']=='' && $_POST['telefono']=='' && $_POST['mensaje']) {
...
try {
	...
	$oMailer->AddAddress("administracion@ladrilloslamarisa.com");
	$oMailer->AddAddress("ventas@ladrilloslamarisa.com");
