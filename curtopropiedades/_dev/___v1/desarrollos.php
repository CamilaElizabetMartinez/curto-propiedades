<?php
	...
	for ($i=0; $i < $cnt; $i++) { 
		...
		if ($count_360>0) {
			$buffer_3601 = '<a href="#" class="btn btn-color2-bg full mg-b" data-toggle="modal" data-target="#modal-360" data-image360-url="'. $img360 .'"><i class="fa fa-camera fa-fw"></i> Ver imágen 360º</a>';
		} else {
			$buffer_3601 = '';
		}
		...
		if ($count_360>0) {
			$buffer_3602 = '<a href="#" class="btn btn-color2-bg full mg-b" data-toggle="modal" data-target="#modal-360" data-image360-url="'. $img360 .'"><i class="fa fa-camera fa-fw"></i> Ver imágen 360º</a>';
		} else {
			$buffer_3602 = '';
		}
		...
		if ($count_360>0) {
			$buffer_3603 = '<a href="#" class="btn btn-color2-bg full mg-b" data-toggle="modal" data-target="#modal-360" data-image360-url="'. $img360 .'"><i class="fa fa-camera fa-fw"></i> Ver imágen 360º</a>';
		} else {
			$buffer_3603 = '';
		}
